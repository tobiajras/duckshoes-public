      ...
      <nav className='flex gap-x-3 sm:gap-x-5 md:gap-x-10 sm:gap-y-2 w-full items-center lg:max-w-6xl mx-auto gridNavbar h-full md:py-3'>
        ...
        <form className='w-full flex' onSubmit={handleSubmit}>
          <input
            ...
            className='align-middle outline-none border-none p-1 px-2 w-full sm:max-w-md md:max-w-lg sm:text-lg'
            type='text'
            placeholder='search...'
            value={inputSearch}
          ...
          />
          <label
            className='flex justify-center items-center px-2 border-l-2 bg-white'
            htmlFor='search'
          >
            <AiOutlineSearch />
          </label>
